...
public abstract class BattleLoc extends Location{
    ...
    public BattleLoc(Player player,String name,Obstacle obstacle,String award,int maxObstracle,int id){
    ...
    public static boolean chance() {
        ...
        int ihtimal = random.nextInt(100); // 0 ile 99 arasında bir rastgele sayı
        return ihtimal < 50;
    }
    ...
    public boolean onLocation(){
        ...
        if (selectCase.equals("S")&& combat(obsNumber)){
            ...
            System.out.println("Buradaki tüm canavarları yendin "+ this.award + " kazandın.");
            switch (getId()){
                case 1:
    ...
    public int randomObstacleNumber(){
        Random r =new Random();
        return r.nextInt(this.getMaxObstracle())+1;
